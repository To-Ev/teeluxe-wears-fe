  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-2 sm:p-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center justify-between border-b pb-4 mb-6">
        <h1 className="text-2xl font-bold text-gray-800">{selectedProduct?.name || "Product Name"}</h1>
        <span className="text-sm text-gray-500">SKU: {selectedProduct?.sku || "SKU"}</span>
      </div>
