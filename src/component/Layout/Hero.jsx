      ...
      <div 
        ...
        <div className=' text-white p-6 col-span-2'>
          <h1 className='text-6xl md:text-8xl font-serif mb-6'>
            African Heritage.<br/> <span className='text-amber-300 italic text-7xl'>Timeless Luxury</span>
          </h1>
          <p 
          ...
          <button className='w-60 bg-amber-600 py-2 rounded-md'>
      ...
      <div 
        ...
        <div className='text-center text-white p-6'>
          <h1 className='text-7xl font-bold uppercase tracking-tighter mb-2'>
            African<br/> <span className='text-amber-300 italic text-6xl'>Heritage</span>
          </h1>
          <p 
