    ...
    <section className='py-12 px-4 h-full lg:px-0'>
        ...
        <div className='relative mx-auto hidden lg:flex overflow-hidden rounded-2x lg:flex-row items-center text-amber-50'>
            ...
            <div className='lg:w-2/3 text-center p-8 lg:text-left z-50 absolute top-1/2 -translate-y-1/2'>
                <div className='flex gap-5 items-center mb-2'>
                    ...
                    <p className='h-0.5 w-35 bg-amber-100/80'></p>
                </div>
                <h2 className='text-4xl text-amber-100 lg:text-6xl font-bold mb-6'>
        ...
        <div className='container lg:hidden mx-auto flex flex-col-reverse item overflow-hidden rounded-2xl bg-gray-900 lg:flex-row items-center shadow-md'>
            ...
            <div className='lg:w-1/2 text-center p-8 lg:text-left'>
                <h2 className='text-md uppercase text-amber-100 mb-2'>
                    Comfort and style
                </h2>
                <h2 className='text-3xl lg:text-5xl font-bold text-amber-200 mb-6'>
                ...
                <Link 
                    to="/collections/all"
                    className='bg-amber-100 text-gray-950 px-6 py-3 rounded-lg text-lg hover:bg-amber-200 transition'
                >
                    Discover now
                </Link>
            </div>
